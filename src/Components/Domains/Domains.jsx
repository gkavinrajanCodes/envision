...
import './Domains.css'
import politics_img from '../../assets/domains-politics.svg'
import healthcare_img from '../../assets/domains-healthcare.svg'
import edutech_img from '../../assets/domains-edutech.svg'

const domainDetails = [
  {
    image: politics_img,
    title: 'Politics',
    description: 'Build innovative solutions to enhance democratic processes, improve civic engagement, and create transparent governance systems. Focus on voter education, policy analysis, and tools that foster political awareness and participation.',
  },
  {
    image: healthcare_img,
    title: 'Healthcare',
    description: 'Develop transformative healthcare technologies that improve patient care, streamline medical processes, and make healthcare more accessible. Address challenges in telemedicine, diagnostics, patient management, and health monitoring.',
  },
  {
    image: edutech_img,
    title: 'Edutech',
    description: 'Create powerful educational tools that revolutionize learning experiences. Focus on personalized learning, skill development, accessibility in education, and innovative platforms that make quality education available to everyone.',
  },
]
